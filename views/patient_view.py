                ...
                if "Yellow" in zone_name:
                    ...
                    with st.expander("📢 วิธีใช้ยาพ่นฉุกเฉิน (MDI) ที่ถูกต้อง (คลิก)"):
                        ...
                        **ขั้นตอนการพ่นยา:**
                        ...
                        ---
                        **⚠️ ข้อควรระวัง:**
                        * หากต้องพ่นซ้ำ ให้พักประมาณ **1-2 นาที** แล้วเริ่มทำใหม่ตั้งแต่ข้อ 2
                        * อาจใช้กระบอกพ่นยา (Spacer) ร่วมด้วยเพื่อประสิทธิภาพที่ดีขึ้น
                        * ควรล้างปากให้สะอาดทุกครั้ง หลังใช้ยาพ่นที่มีส่วนผสมของสเตียรอยด์ (เช่น Seretide, Budesonide)
                        """)
